...
final rabies = AntigenSupportingData.fromJson({
    ...
    "series": [
        {
            "seriesName": "Risk continuous exposure series",
            "targetDisease": "Rabies",
            "vaccineGroup": "Rabies",
            "seriesAdminGuidance": [
        ...
        {
            "seriesName": "Risk frequent exposure series",
            "targetDisease": "Rabies",
            "vaccineGroup": "Rabies",
            "seriesAdminGuidance": [
            ...
            "indication": [
                ...
                },
                {
                    ...
                    "beginAge": "0 days",
                    "guidance": "For example, biologists who frequently enter bat roosts or who collect suspected rabies samples."
                }
            ],
            "seriesDose": [
                {
        ...
        {
            "seriesName": "Risk infrequent exposure series",
            "targetDisease": "Rabies",
            "vaccineGroup": "Rabies",
            "seriesAdminGuidance": [
                "For persons who risk for rabies exposure is greater than 3 years, two options are available within the 3 years after primary series. 1) a one-time a titer check at 1-3 years after the primary series. A single booster should be administered if the titer is below 0.5 IU/mL. 2) preemptively receive a one-time booster on or after day 21 to year 3 after completion of the 2-dose primary series.",
            ...
            "indication": [
                {
                    ...
                    "beginAge": "0 days",
                    "guidance": "Occupational or recreational activities that typically involve contact with animals include 1) veterinarians, technicians, animal control officers, and their students or trainees; 2) persons who handle wildlife reservoir species (e.g., wildlife biologists, rehabilitators, and trappers); and 3) spelunkers"
                },
                {
                    "observationCode": {
                    ...
                    "beginAge": "0 days",
                    "guidance": "PrEP considerations include whether the travelers 1) will be performing occupational or recreational activities that increase risk for exposure to potentially rabid animals (particularly dogs) and 2) might have difficulty getting prompt access to safe PEP (e.g., rural part of a country or far from closest PEP clinic)"
                }
            ],
            "seriesDose": [
                {
